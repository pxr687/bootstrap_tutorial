...
The code cell below draws a random sample from the population data.  The graph on the left below shows the full population of baby birthweights; the graph on the right shows a random sample of 25 of the baby birthweights (highlighted in red):
